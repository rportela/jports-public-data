 ...
 * Commodities, Interest Rate, Currency, Equities, Indexes. Since each file has
 * it's own naming convention, the annotation @Up2DataTable is present on the
 * descendant classes.
 * 
...
public class EODPrice {
	 ...
	 * 
	 * <p>
	 * Identification the exchange as stipulated in the norm ISO 10383 "Codes for
	 * exchanges and market identifications". This tag is optional and if no
	 ...
	 * 
	 * <p>
	 * A numbering system designed by the United Nation's International Organization
	 * for Standardization (ISO). The ISIN is composed of a 2-character prefix
